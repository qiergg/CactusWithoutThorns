package com.aebiz.sdk.UIKit.component.staggeredgrid;
...
public abstract class DefaultStaggeredListViewController implements IStaggeredListViewController {
    ...
    public void onScrollStateChanged(AbsListView view, int scrollState) {
        ...
        if (scrollState == OnScrollListener.SCROLL_STATE_IDLE || scrollState == OnScrollListener.SCROLL_STATE_TOUCH_SCROLL) {// 滚动停止
            onScrollPaused();
        } else if (scrollState == OnScrollListener.SCROLL_STATE_FLING) {// 滚动开始
            onScrollResumed();
        }
    }
