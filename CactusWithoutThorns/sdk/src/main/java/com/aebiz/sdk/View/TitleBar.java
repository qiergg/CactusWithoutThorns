...
public class TitleBar extends RelativeLayout implements View.OnClickListener {
    ...
    private void initView() {
        ...
        mTitleBarView = (RelativeLayout) findViewById(R.id.title_bar);
        mTitleBarLeftView = (RelativeLayout) findViewById(R.id.title_bar_left);
        mTitleBarCenterView = (RelativeLayout) findViewById(R.id.title_bar_center);
        mTitleBarRightView = (RelativeLayout) findViewById(R.id.title_bar_right);
        mTitleBarLeftDefaultView = (TextView) findViewById(R.id.title_bar_left_default);
        mTitleBarCenterDefaultView = (TextView) findViewById(R.id.title_bar_center_default);
        mTitleBarRightDefaultView = (TextView) findViewById(R.id.title_bar_right_default);
    }
    ...
    private void initFromAttributes(AttributeSet attrs) {
        ...
        mTitle = a.getString(R.styleable.TitleBar_mtitle);
