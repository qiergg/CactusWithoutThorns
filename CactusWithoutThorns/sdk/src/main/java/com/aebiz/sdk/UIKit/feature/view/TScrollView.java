...
import com.aebiz.sdk.UIKit.feature.callback.CanvasCallback;
import com.aebiz.sdk.UIKit.feature.callback.FocusCallback;
import com.aebiz.sdk.UIKit.feature.callback.InterceptTouchEventCallback;
import com.aebiz.sdk.UIKit.feature.callback.LayoutCallback;
import com.aebiz.sdk.UIKit.feature.callback.MeasureCallback;
import com.aebiz.sdk.UIKit.feature.callback.ScrollCallback;
import com.aebiz.sdk.UIKit.feature.callback.SetClipToPaddingCallBack;
...
import com.aebiz.sdk.UIKit.utils.IFeatureList;
...
public class TScrollView extends ScrollView implements ViewHelper, ViewGroupHelper, IFeatureList<ScrollView> {
    ...
    private List<OnHierarchyChangeListener> mOnHierarchyChangeListeners = new ArrayList<OnHierarchyChangeListener>();
    ...
    public TScrollView(Context context, AttributeSet attrs, int defStyle) {
        ...
        super.setOnHierarchyChangeListener(new OnHierarchyChangeListener() {
            ...
            public void onChildViewAdded(View parent, View child) {
                for (OnHierarchyChangeListener l : mOnHierarchyChangeListeners) {
